    ...
    <div className="rounded-xl border border-border/[0.08] bg-card p-5 h-full flex flex-col overflow-hidden">
      ...
      {evidence === null ? (
        ...
        <div className="flex-1 space-y-2 animate-pulse">
          ...
          <div className="h-40 rounded bg-white/[0.03] mt-4" />
        </div>
      ) : evidence.kind === "none" ? (
        ...
        /* json */
        <pre className="flex-1 overflow-auto text-[10px] leading-relaxed bg-white/[0.02] rounded-lg p-3 font-mono text-muted-foreground/80 whitespace-pre-wrap break-all">
